...
class AmplifierTests {
    ...
    fun `max signal example program 1`() {
        ...
        // Act
        val maxSignal = computeMaxSignal(program, withFeedback = false)
    ...
    @Test
    fun `max feedback signal example program 1`() {
        // Arrange
        val program = listOf(
        ...
        // Act
        val maxSignal = computeMaxSignal(program, withFeedback = true)

        // Assert
        assertEquals(139629729, maxSignal)
    }

    @Test
    fun `max feedback signal example program 2`() {
        // Arrange
        val program = listOf(
